                ...
                <div className="flex ">
                    ...
                    <div className="flex flex-col w-4/12 h-screen p-10 bg-[#41924B] items-center">
                        ...
                        <div className="text-center rounded-lg py-3 px-5 text-sm bg-[#F1F6FA] mb-10"> 
                            <p className="mb-2">Upload a new avatar. Larger image will be resized automatically</p>
                    ...
                    <div className="flex w-full flex-col pl-20 bg-white p-5">
                        ...
                        <div className="border-b-2 pb-5 my-10">
                            <h1 className="text-3xl font-bold text-neutral-950">Edit Profile</h1>
                        </div>

                        <div className="grid grid-cols-2 mx-10 ">
                            <div className="card mb-16">
                                <h2 className="text-xl text-neutral-400 font-semibold mb-3">Full Name</h2>
                                <input type="text" className="w-9/12 border-b-2 px-1 py-2 " />
                            </div>
                            <div className="card mb-16">
                                <h2 className="text-xl text-neutral-400 font-semibold mb-3">Username</h2>
                                <input type="text"  className="w-9/12 border-b-2 px-1 py-2"/>
                            </div>
                            <div className="card mb-16">
                                ...
                                <div className="flex items-center w-9/12 justify-center border-b-2">
                                    <div className="w-full">
                                        <input type={(visiblePass === false)? "password": "text"} className="w-11/12 px-1 py-2" />
                                    </div>
                                    <div>
                                        {
                            ...
                            <div className="card mb-16">
                                ...
                                <div className="flex items-center w-9/12 justify-center border-b-2 ">
                                    <div className="w-full">
                                        <input type={(visibleRePass === false)? "password": "text"} className="w-11/12 px-1 py-2" />
                                    </div>
                                    <div>
                                        {
                                            (visibleRePass === false)? <BsFillEyeFill size={25} onClick={toggleRePassword}/>:
                            ...
                            <div className="card mb-16 ">
                                <h2 className="text-xl text-neutral-400 font-semibold mb-3">Email Address</h2>
                                <input type="email" className="w-9/12 border-b-2 px-1 py-2" />
                            </div>
                            <div className="card mb-16">
                                <h2 className="text-xl text-neutral-400 font-semibold mb-3">Confirm Email Address</h2>
                                <input type="email" className="w-9/12 border-b-2 px-1 py-2" />
                            </div>
                        </div>
                        ...
                        <div className="flex justify-end pb-40 mx-10 mt-10">
                            <div className="bg-[#41924B] rounded-full mr-[126px]">
                                <button className="text-slate-50 font-semibold px-16 py-3 text-lg ">Update Profile</button>
                            </div>
                        </div>
                    </div>
                </div>   
