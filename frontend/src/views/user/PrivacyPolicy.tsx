...
function PrivacyPolicy() {
  return (
    <div className="max-w-screen-2xl mx-auto px-4">
      <Navbar />
      <div className="flex bg-[#41924B] h-52 justify-center items-center px-10">
      ...
      <div className="flex flex-col bg-[#CCD3CA] justify-center items-start p-10 gap-y-5 rounded-xl">
        <div>
          ...
          <p>
            ...
            appointment through our website, we may collect personal information
        ...
        <div>
          ...
          <p>
            a. Our website is not intended for children under the age of 13. We
