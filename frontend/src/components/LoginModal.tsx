                ...
                <div className="flex flex-col justify-center items-center w-[300px] h-fit mt-5">
                    ...
                    <div className="flex flex-col w-full items-center mt-5">
                        <div className="text-sm">
                            <p>Forgot your <a href="" className="text-[#41924B]">username</a> or <a href="" className="text-[#41924B]">password</a>?</p>
                        </div>
                        <div>
                            <button onClick={onSwitchToSignUp} className="font-bold text-[#41924B] mt-2" >SIGN UP</button> {/* Switch to sign up modal */}
                        </div>
                    </div>
                </div>
