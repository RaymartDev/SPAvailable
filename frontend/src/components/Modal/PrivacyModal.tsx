...
function PrivacyModal({ open, onClose }: LoginModalProps) {
  if (!open) return null;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center z-20">
      <div className="flex flex-col items-center w-[464px] h-[659px] bg-slate-50 rounded-2xl pb-10">
        ...
        <div className="flex flex-col overflow-y-scroll h-full px-10 text-sm">
          <div className="">
            <p className="">
              Thank you for using SPAvailable. This Privacy Policy explains how
              we collect, use, and protect your personal information when you
              use our website to discover and schedule spa appointments. By
              using our website, you consent to the data practices described in
              this policy.
            </p>
          </div>
          <div>
          ...
          <div>
            <h1 className="font-semibold">Use of Information:</h1>
            <p>
          ...
          <div>
            <h1 className="font-semibold">Sharing of Information:</h1>
            <p>
          ...
          <div>
            <h1 className="font-semibold">Third-Party Services:</h1>
            <p>
          ...
          <div>
            <h1 className="font-semibold">Your Choices:</h1>
            <p>
          ...
          <div>
            <h1 className="font-semibold">Changes to This Policy:</h1>
            <p>
